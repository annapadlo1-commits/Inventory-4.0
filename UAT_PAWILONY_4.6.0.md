# Inventory PRO PAWILONY 4.6.0 — UAT
...
- Nowe kontrakty mobilne, lokalizacyjne i bezpieczeństwa: 30/30 PASS.
...
4. Przeanalizuj `dark rum Fritz Kola 1`, `lodówki Bombilla 7` oraz pozycję z sekcji PIWO BUTELKI. `dark rum` ma oznaczać DARKROOM, a lokalizacja wypowiedziana bezpośrednio przy produkcie ma mieć pierwszeństwo przed kontekstem.
...
11. Wpisz `Czarna Fala Przelew 1 kg 12`. Finalna wartość ma zostać zapisana wyłącznie w kolumnie B, bez tworzenia lub naprawiania formuł.
...
Uwaga: testy lokalne nie wysyłają danych do żywego arkusza. Powyższe scenariusze należy wykonać po wdrożeniu jako kontrolowany test akceptacyjny na kopii arkusza albo na wyznaczonych wierszach testowych.
